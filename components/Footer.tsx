    ...
    <footer className="relative mt-12 bg-sukem-card text-sukem-text-muted pt-12 pb-6 overflow-hidden transition-colors duration-300 border-t-0">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center space-y-3 max-w-4xl mx-auto">
          ...
          {/* Slogan*/}
          <p className="text-sukem-text-muted text-xs sm:text-sm leading-relaxed max-w-xl mx-auto px-8">
            Nền tảng đọc web novel/tiểu thuyết miễn phí.
            Với trải nghiệm đọc tuyệt vời, không quảng cáo làm phiền.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-2 pt-2">
            <a
              ...
              title="Fanpage"
              aria-label="Fanpage"
              className="group flex items-center justify-center w-10 h-10 rounded-full bg-sukem-bg hover:bg-blue-50 border border-sukem-border hover:border-blue-200 transition-all duration-300 shadow-sm hover:shadow-md"
            >
            ...
            <a
              ...
              title="Liên hệ"
              aria-label="Liên hệ"
              className="group flex items-center justify-center w-10 h-10 rounded-full bg-sukem-bg hover:bg-amber-50 border border-sukem-border hover:border-amber-200 transition-all duration-300 shadow-sm hover:shadow-md"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-sukem-text-muted group-hover:text-amber-600 transition-colors">
