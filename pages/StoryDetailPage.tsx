                                ...
                                <div className="flex flex-wrap gap-3 mt-4 md:flex-nowrap md:gap-2">
                                    ...
                                    {currentBookmark ? (
                                        <Link
                                            ...
                                            className="btn-primary py-3 md:py-2.5 rounded-lg flex items-center justify-center gap-2 font-bold text-white bg-sukem-primary hover:bg-sukem-primary/90 transition-colors w-full md:w-auto md:flex-1 text-base md:text-sm active:scale-95 border border-sukem-primary"
                                        >
                                        ...
                                        <Link
                                            ...
                                            className={cn(
                                                "btn-primary py-3 md:py-2.5 rounded-lg flex items-center justify-center gap-2 font-bold text-white bg-sukem-primary hover:bg-sukem-primary/90 transition-colors w-full md:w-auto md:flex-1 text-base md:text-sm active:scale-95 border border-sukem-primary",
